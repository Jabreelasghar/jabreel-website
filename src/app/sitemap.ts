...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: Array<[string, MetadataRoute.Sitemap[number]["changeFrequency"], number]> = [
    ...
    ["/thinklab", "monthly", 0.9], ["/thinklab/about", "monthly", 0.7],
    ["/thinklab/workshops", "monthly", 0.7], ["/thinklab/pilot", "monthly", 0.8],
    ["/thinklab/research", "monthly", 0.7], ["/thinklab/faq", "monthly", 0.7],
    ["/thinklab/register", "monthly", 0.6],
